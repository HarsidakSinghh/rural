...
const translations = {
  en: {
    ...
    'welcome_to_gram_samachar': 'Welcome to Gram Samachar',
  ...
  hi: {
    ...
    'welcome_to_gram_samachar': 'ग्राम समाचार में आपका स्वागत है',
  ...
  pa: {
    ...
    'welcome_to_gram_samachar': 'ਗ੍ਰਾਮ ਸਮਾਚਾਰ ਵਿੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ',
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const translateContent = async (text: string): Promise<string> => {
    ...
    try {
      ...
      const translatedText = await translationService.translateWithCache(text, targetLang);
