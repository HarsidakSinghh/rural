...
import { User, Video, Shield, LogIn, UserPlus, Moon, Sun, Languages, Menu, X } from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  const toggleLanguage = async () => {
    ...
    // If we're on a news detail page, trigger content translation
    if (location.pathname.startsWith('/news/')) {
      // The NewsDetail component will handle translation via useEffect
